...
The focus is on security visibility, detection logic, and structured reporting rather than open-source tooling.
...
- Generation of structured security findings suitable for compliance documentation
...
- PCI DSS v4.0
- Requirement 11.6.1 – Detection of unauthorized script changes

---

## Portfolio Note
Source code is intentionally not published.  
This repository is used to demonstrate security concepts, detection approaches, and reporting aligned with real-world compliance requirements.
